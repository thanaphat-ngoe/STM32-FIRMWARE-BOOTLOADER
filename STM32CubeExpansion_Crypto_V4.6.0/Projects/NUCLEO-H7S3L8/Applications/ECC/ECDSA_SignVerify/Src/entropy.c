/**
  ...
  * @note    This solution should be used only if the target device does not provide
...
if (HAL_TIMEx_TISelection(&htimx, TIM_TIM12_TI1_HSI_1024, TIM_CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
  /* TIM interrupt Init */
