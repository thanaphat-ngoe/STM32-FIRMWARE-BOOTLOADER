/**
  @page SHAKE_Digest Hash example

  @verbatim
  ******************************************************************************
  * @file    Applications/Hash/SHAKE_Digest/readme.txt
  * @author  MCD Application Team
  * @brief   Description of the SHAKE_Digest example.
  ******************************************************************************
  *
...
@note NIST vectors examples for SHAKE are taken from:
...
Cryptography, digest, SHAKE, Cryptographic

@par Directory contents

  - Hash/SHAKE_Digest/Inc/stm32h7rsxx_nucleo_conf.h     BSP configuration file
  - Hash/SHAKE_Digest/Inc/stm32h7rsxx_hal_conf.h    HAL configuration file
  - Hash/SHAKE_Digest/Inc/stm32h7rsxx_it.h          Interrupt handlers header file
  - Hash/SHAKE_Digest/Inc/main.h                        Header for main.c module
  - Hash/SHAKE_Digest/Src/stm32h7rsxx_it.c          Interrupt handlers
  - Hash/SHAKE_Digest/Src/stm32h7rsxx_hal_msp.c     HAL MSP module
  - Hash/SHAKE_Digest/Src/main.c                        Main program
  - Hash/SHAKE_Digest/Src/system_stm32h7rsxx.c      STM32H7RSxx system source file
  - Hash/SHAKE_Digest/Src/cmox_low_level.c              CMOX low level services implementation
