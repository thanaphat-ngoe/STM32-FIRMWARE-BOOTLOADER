...
@note This example is long to execute, it can take up to few seconds before the led is turned on.
...
@par Directory contents
  ...
  - RSA/PKCS1v2.2_EncryptDecrypt/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - RSA/PKCS1v2.2_EncryptDecrypt/Inc/stm32g0xx_it.h          Interrupt handlers header file
  - RSA/PKCS1v2.2_EncryptDecrypt/Inc/main.h                        Header for main.c module
  - RSA/PKCS1v2.2_EncryptDecrypt/Src/stm32g0xx_it.c          Interrupt handlers
  - RSA/PKCS1v2.2_EncryptDecrypt/Src/stm32g0xx_hal_msp.c     HAL MSP module
  - RSA/PKCS1v2.2_EncryptDecrypt/Src/main.c                        Main program
  - RSA/PKCS1v2.2_EncryptDecrypt/Src/system_stm32g0xx.c      STM32G0xx system source file
