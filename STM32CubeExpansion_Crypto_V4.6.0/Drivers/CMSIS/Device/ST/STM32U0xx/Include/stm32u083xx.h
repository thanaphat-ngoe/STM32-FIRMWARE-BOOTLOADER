...
typedef struct
{
  ...
  __IO uint32_t SUSPR0;      /*!< AES Suspend register 0,                      Address offset: 0x40 */
  __IO uint32_t SUSPR1;      /*!< AES Suspend register 1,                      Address offset: 0x44 */
  __IO uint32_t SUSPR2;      /*!< AES Suspend register 2,                      Address offset: 0x48 */
  __IO uint32_t SUSPR3;      /*!< AES Suspend register 3,                      Address offset: 0x4C */
  __IO uint32_t SUSPR4;      /*!< AES Suspend register 4,                      Address offset: 0x50 */
  __IO uint32_t SUSPR5;      /*!< AES Suspend register 5,                      Address offset: 0x54 */
  __IO uint32_t SUSPR6;      /*!< AES Suspend register 6,                      Address offset: 0x58 */
  __IO uint32_t SUSPR7;      /*!< AES Suspend register 7,                      Address offset: 0x5C */
...
/*******************  Bit definition for AES_SUSPR0 register  ******************/
#define AES_SUSPR0_Pos                      (0UL)
#define AES_SUSPR0_Msk                      (0xFFFFFFFFUL << AES_SUSPR0_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR0                          AES_SUSPR0_Msk                          /*!< AES Suspend registers 0 */

/*******************  Bit definition for AES_SUSPR1 register  ******************/
#define AES_SUSPR1_Pos                      (0UL)
#define AES_SUSPR1_Msk                      (0xFFFFFFFFUL << AES_SUSPR1_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR1                          AES_SUSPR1_Msk                          /*!< AES Suspend registers 1 */

/*******************  Bit definition for AES_SUSPR2 register  ******************/
#define AES_SUSPR2_Pos                      (0UL)
#define AES_SUSPR2_Msk                      (0xFFFFFFFFUL << AES_SUSPR2_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR2                          AES_SUSPR2_Msk                          /*!< AES Suspend registers 2 */

/*******************  Bit definition for AES_SUSPR3 register  ******************/
#define AES_SUSPR3_Pos                      (0UL)
#define AES_SUSPR3_Msk                      (0xFFFFFFFFUL << AES_SUSPR3_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR3                          AES_SUSPR3_Msk                          /*!< AES Suspend registers 3 */

/*******************  Bit definition for AES_SUSPR4 register  ******************/
#define AES_SUSPR4_Pos                      (0UL)
#define AES_SUSPR4_Msk                      (0xFFFFFFFFUL << AES_SUSPR4_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR4                          AES_SUSPR4_Msk                          /*!< AES Suspend registers 4 */

/*******************  Bit definition for AES_SUSPR5 register  ******************/
#define AES_SUSPR5_Pos                      (0UL)
#define AES_SUSPR5_Msk                      (0xFFFFFFFFUL << AES_SUSPR5_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR5                          AES_SUSPR5_Msk                          /*!< AES Suspend registers 5 */

/*******************  Bit definition for AES_SUSPR6 register  ******************/
#define AES_SUSPR6_Pos                      (0UL)
#define AES_SUSPR6_Msk                      (0xFFFFFFFFUL << AES_SUSPR6_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR6                          AES_SUSPR6_Msk                          /*!< AES Suspend registers 6 */

/*******************  Bit definition for AES_SUSPR7 register  ******************/
#define AES_SUSPR7_Pos                      (0UL)
#define AES_SUSPR7_Msk                      (0xFFFFFFFFUL << AES_SUSPR7_Pos)        /*!< 0xFFFFFFFF */
#define AES_SUSPR7                          AES_SUSPR7_Msk                          /*!< AES Suspend registers 7 */
...
#define RCC_AHBRSTR_AESRST_Pos        (16UL)
...
#define RCC_AHBENR_AESEN_Pos           (16UL)
...
#define RCC_AHBSMENR_AESSMEN_Pos       (16UL)
...
#define SYSCFG_ITLINE31_SR_AES_Pos         (1UL)
