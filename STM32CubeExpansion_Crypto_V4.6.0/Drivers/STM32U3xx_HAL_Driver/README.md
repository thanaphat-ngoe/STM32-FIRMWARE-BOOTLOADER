...
**STM32Cube** covers the overall STM32 products portfolio. It includes a comprehensive embedded software platform, delivered for each STM32 series.
   ...
   * A consistent set of middlewares components such as ThreadX, FileX, USBX, OpenBootloader, mbed-crypto, Touch Sense...
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32u3xx_hal_driver/blob/master/Release_Notes.html).
