...
#define LL_PWR_PVDLEVEL_7       (PWR_CR2_PLS_2 | PWR_CR2_PLS_1 | PWR_CR2_PLS_0)   /* External input analog voltage
...
/**
  ...
  * @param  SRAMSize This parameter can be one of the following values:
...
/**
  ...
  * @note   Take care, return value "0" means the regulator is ready. Return value "1" means the output voltage range
  *         is still changing.
...
/**
  * @brief  Indicate whether the regulator is ready in the selected voltage range or if its output voltage is
  *         still changing to the required voltage level
