...
#ifndef __STM32U0xx_LL_TIM_H
#define __STM32U0xx_LL_TIM_H
...
#if defined(COMP2)
#define LL_TIM_ETRSOURCE_COMP2                 TIM_AF1_ETRSEL_1                        /*!< ETR input is connected to COMP2_OUT */
#endif /* COMP2 */
...
#if defined(COMP2)
#define LL_TIM_OCREF_CLR_INT_COMP2       TIM_OR1_OCREF_CLR           /*!< OCREF clear input is connected to COMP2_OUT */
#endif /* COMP2 */
/**
  * @}
  */
...
__STATIC_INLINE void LL_TIM_SetOCRefClearInputSource(TIM_TypeDef *TIMx, uint32_t OCRefClearInputSource)
{
  ...
  MODIFY_REG(TIMx->OR1, TIM_OR1_OCREF_CLR, OCRefClearInputSource);
}
/**
  * @}
  */
