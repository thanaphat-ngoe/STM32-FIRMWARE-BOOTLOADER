...
#ifndef STM32U0xx_HAL_TIM_H
#define STM32U0xx_HAL_TIM_H
...
#if defined(COMP2)
#define TIM_CLEARINPUTSOURCE_COMP2          TIM_OR1_OCREF_CLR                   /*!< OCREF_CLR_INT is connected to COMP2 output */
#endif /* COMP2 */
/**
  * @}
  */
...
/** @defgroup TIM_Break_System TIM Break System
  * @{
  */
#define TIM_BREAK_SYSTEM_ECC                 SYSCFG_CFGR2_ECCL   /*!< Enables and locks the ECC error signal with Break Input of TIM1/15/16 */
#define TIM_BREAK_SYSTEM_PVD                 SYSCFG_CFGR2_PVDL   /*!< Enables and locks the PVD connection with TIM1/15/16 Break Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR   SYSCFG_CFGR2_SPL    /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/15/16 */
#define TIM_BREAK_SYSTEM_LOCKUP              SYSCFG_CFGR2_CCL    /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/15/16 */
/**
  * @}
  */
...
#include "stm32u0xx_hal_tim_ex.h"
