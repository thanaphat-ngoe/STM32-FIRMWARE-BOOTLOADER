...
#ifndef STM32U0xx_HAL_COMP_H
#define STM32U0xx_HAL_COMP_H
...
#define COMP_INPUT_PLUS_IO4 (COMP_CSR_INPSEL_1 | COMP_CSR_INPSEL_0) /*!< Comparator input plus connected to IO4 (pin PA9 for COMP1, pin PD10 for COMP2) */
#define COMP_INPUT_PLUS_IO5 (COMP_CSR_INPSEL_2 )                    /*!< Comparator input plus connected to IO5 (pin PC6 for COMP1, not applicable for COMP2) */
/**
  * @}
  */
...
#define COMP_INPUT_MINUS_IO1           (                    COMP_CSR_INMSEL_2                     | COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO1 (pin PC4 for COMP1, pin PB7 for COMP2) */
#define COMP_INPUT_MINUS_IO2           (                    COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1                    ) /*!< Comparator input minus connected to IO2 (pin PB1 for COMP1, pin PB3 for COMP2) */
#define COMP_INPUT_MINUS_IO3           (                    COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO3 (pin PA0 for COMP1, pin PA2 for COMP2) */
#define COMP_INPUT_MINUS_IO4           (COMP_CSR_INMSEL_3                                                            ) /*!< Comparator input minus connected to IO4 (pin PA4 for COMP1, pin PA4 for COMP2) */
#define COMP_INPUT_MINUS_IO5           (COMP_CSR_INMSEL_3                                         | COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO5 (pin PA5 for COMP1, pin PA5 for COMP2) */
/**
  * @}
  */
...
#define COMP_BLANKINGSRC_TIM1_OC4        (COMP_CSR_BLANKSEL_0)   /*!< Comparator output blanking source TIM1 OC4 (common to all COMP instances: COMP1, COMP2 ) */
#define COMP_BLANKINGSRC_TIM1_OC5        (COMP_CSR_BLANKSEL_1)   /*!< Comparator output blanking source TIM1 OC5 (common to all COMP instances: COMP1, COMP2 ) */
#define COMP_BLANKINGSRC_TIM2_OC3        (COMP_CSR_BLANKSEL_2)   /*!< Comparator output blanking source TIM2 OC3 (common to all COMP instances: COMP1, COMP2 ) */
#define COMP_BLANKINGSRC_TIM3_OC3        (COMP_CSR_BLANKSEL_3)   /*!< Comparator output blanking source TIM3 OC3 (common to all COMP instances: COMP1, COMP2 ) */
#define COMP_BLANKINGSRC_TIM15_OC2       (COMP_CSR_BLANKSEL_4)   /*!< Comparator output blanking source TIM15 OC2 (common to all COMP instances: COMP1, COMP2 ) */
/**
  * @}
  */
