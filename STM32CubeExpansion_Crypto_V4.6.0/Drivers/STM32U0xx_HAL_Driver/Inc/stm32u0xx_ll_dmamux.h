...
#ifndef STM32U0xx_LL_DMAMUX_H
#define STM32U0xx_LL_DMAMUX_H
...
#endif /* AES */
#define LL_DMAMUX_REQ_DAC_CH1             0x00000008U  /*!< DMAMUX DAC_CH1       request    */
#define LL_DMAMUX_REQ_I2C1_RX             0x00000009U  /*!< DMAMUX I2C1 RX       request   */
#define LL_DMAMUX_REQ_I2C1_TX             0x0000000AU  /*!< DMAMUX I2C1 TX       request   */
#define LL_DMAMUX_REQ_I2C2_RX             0x0000000BU  /*!< DMAMUX I2C2 RX       request   */
#define LL_DMAMUX_REQ_I2C2_TX             0x0000000CU  /*!< DMAMUX I2C2 TX       request   */
#define LL_DMAMUX_REQ_I2C3_RX             0x0000000DU  /*!< DMAMUX I2C3 RX       request   */
#define LL_DMAMUX_REQ_I2C3_TX             0x0000000EU  /*!< DMAMUX I2C3 TX       request   */
#if defined(I2C4)
#define LL_DMAMUX_REQ_I2C4_RX             0x0000000FU  /*!< DMAMUX I2C4 RX       request   */
#define LL_DMAMUX_REQ_I2C4_TX             0x00000010U  /*!< DMAMUX I2C4 TX       request   */
#endif /* I2C4 */
#define LL_DMAMUX_REQ_LPTIM1_IC1          0x00000011U  /*!< DMAMUX LPTIM1 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC2          0x00000012U  /*!< DMAMUX LPTIM1 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC3          0x00000013U  /*!< DMAMUX LPTIM1 IC3    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC4          0x00000014U  /*!< DMAMUX LPTIM1 IC4    request   */
#define LL_DMAMUX_REQ_LPTIM1_UE           0x00000015U  /*!< DMAMUX LPTIM1 UE     request   */
#define LL_DMAMUX_REQ_LPTIM2_IC1          0x00000016U  /*!< DMAMUX LPTIM2 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM2_IC2          0x00000017U  /*!< DMAMUX LPTIM2 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM2_UE           0x00000018U  /*!< DMAMUX LPTIM2 UE     request   */
#if defined(LPTIM3)
#define LL_DMAMUX_REQ_LPTIM3_IC1          0x00000019U  /*!< DMAMUX LPTIM3 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC2          0x0000001AU  /*!< DMAMUX LPTIM3 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC3          0x0000001BU  /*!< DMAMUX LPTIM3 IC3    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC4          0x0000001CU  /*!< DMAMUX LPTIM3 IC4    request   */
#define LL_DMAMUX_REQ_LPTIM3_UE           0x0000001DU  /*!< DMAMUX LPTIM3 UE     request   */
#endif /* LPTIM3 */
#define LL_DMAMUX_REQ_LPUART1_RX          0x0000001EU  /*!< DMAMUX LPUART1 RX    request   */
#define LL_DMAMUX_REQ_LPUART1_TX          0x0000001FU  /*!< DMAMUX LPUART1 TX    request   */
#define LL_DMAMUX_REQ_LPUART2_RX          0x00000020U  /*!< DMAMUX LPUART2 RX    request   */
#define LL_DMAMUX_REQ_LPUART2_TX          0x00000021U  /*!< DMAMUX LPUART2 TX    request   */
#if defined(LPUART3)
#define LL_DMAMUX_REQ_LPUART3_RX          0x00000022U  /*!< DMAMUX LPUART3 RX    request   */
#define LL_DMAMUX_REQ_LPUART3_TX          0x00000023U  /*!< DMAMUX LPUART3 TX    request   */
#endif /* LPUART */
#define LL_DMAMUX_REQ_SPI1_RX             0x00000024U  /*!< DMAMUX SPI1 RX       request   */
#define LL_DMAMUX_REQ_SPI1_TX             0x00000025U  /*!< DMAMUX SPI1 TX       request   */
#define LL_DMAMUX_REQ_SPI2_RX             0x00000026U  /*!< DMAMUX SPI2 RX       request   */
#define LL_DMAMUX_REQ_SPI2_TX             0x00000027U  /*!< DMAMUX SPI2 TX       request   */
#if defined(SPI3)
#define LL_DMAMUX_REQ_SPI3_RX             0x00000028U  /*!< DMAMUX SPI3 RX       request   */
#define LL_DMAMUX_REQ_SPI3_TX             0x00000029U  /*!< DMAMUX SPI3 TX       request   */
#endif /* SPI3 */
...
#define LL_DMAMUX_REQ_TIM1_TRIG_COM       0x0000002EU  /*!< DMAMUX TIM1 TRIG COM request   */
#define LL_DMAMUX_REQ_TIM1_UP             0x0000002FU  /*!< DMAMUX TIM1 UP       request   */
#define LL_DMAMUX_REQ_TIM2_CH1            0x00000030U  /*!< DMAMUX TIM2 CH1      request   */
#define LL_DMAMUX_REQ_TIM2_CH2            0x00000031U  /*!< DMAMUX TIM2 CH2      request   */
#define LL_DMAMUX_REQ_TIM2_CH3            0x00000032U  /*!< DMAMUX TIM2 CH3      request   */
#define LL_DMAMUX_REQ_TIM2_CH4            0x00000033U  /*!< DMAMUX TIM2 CH4      request   */
#define LL_DMAMUX_REQ_TIM2_TRIG           0x00000034U  /*!< DMAMUX TIM2 TRIG     request   */
#define LL_DMAMUX_REQ_TIM2_UP             0x00000035U  /*!< DMAMUX TIM2 UP       request   */
#define LL_DMAMUX_REQ_TIM3_CH1            0x00000036U  /*!< DMAMUX TIM3 CH1      request   */
#define LL_DMAMUX_REQ_TIM3_CH2            0x00000037U  /*!< DMAMUX TIM3 CH2      request   */
#define LL_DMAMUX_REQ_TIM3_CH3            0x00000038U  /*!< DMAMUX TIM3 CH3      request   */
#define LL_DMAMUX_REQ_TIM3_CH4            0x00000039U  /*!< DMAMUX TIM3 CH4      request   */
#define LL_DMAMUX_REQ_TIM3_TRIG           0x0000003AU  /*!< DMAMUX TIM3 TRIG     request   */
#define LL_DMAMUX_REQ_TIM3_UP             0x0000003BU  /*!< DMAMUX TIM3 UP       request   */
#define LL_DMAMUX_REQ_TIM6_UP             0x0000003CU  /*!< DMAMUX TIM6 UP       request   */
#define LL_DMAMUX_REQ_TIM7_UP             0x0000003DU  /*!< DMAMUX TIM7 UP       request   */
#define LL_DMAMUX_REQ_TIM15_CH1           0x0000003EU  /*!< DMAMUX TIM15 CH1     request   */
#define LL_DMAMUX_REQ_TIM15_CH2           0x0000003FU  /*!< DMAMUX TIM15 CH2     request   */
#define LL_DMAMUX_REQ_TIM15_TRIG_COM      0x00000040U  /*!< DMAMUX TIM15 TRIG COMrequest   */
#define LL_DMAMUX_REQ_TIM15_UP            0x00000041U  /*!< DMAMUX TIM15 UP      request   */
#define LL_DMAMUX_REQ_TIM16_CH1           0x00000042U  /*!< DMAMUX TIM16 CH1     request   */
#define LL_DMAMUX_REQ_TIM16_COM           0x00000043U  /*!< DMAMUX TIM16 COM     request   */
#define LL_DMAMUX_REQ_TIM16_UP            0x00000044U  /*!< DMAMUX TIM16 UP      request   */
#define LL_DMAMUX_REQ_USART1_RX           0x00000045U  /*!< DMAMUX USART1 RX     request   */
#define LL_DMAMUX_REQ_USART1_TX           0x00000046U  /*!< DMAMUX USART1 TX     request   */
#define LL_DMAMUX_REQ_USART2_RX           0x00000047U  /*!< DMAMUX USART2 RX     request   */
#define LL_DMAMUX_REQ_USART2_TX           0x00000048U  /*!< DMAMUX USART2 TX     request   */
#define LL_DMAMUX_REQ_USART3_RX           0x00000049U  /*!< DMAMUX USART3 RX     request   */
#define LL_DMAMUX_REQ_USART3_TX           0x0000004AU  /*!< DMAMUX USART3 TX     request   */
#define LL_DMAMUX_REQ_USART4_RX           0x0000004BU  /*!< DMAMUX USART4 RX     request   */
#define LL_DMAMUX_REQ_USART4_TX           0x0000004CU  /*!< DMAMUX USART4 TX     request   */
...
#define LL_DMAMUX_SYNC_EXTI_LINE15        (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1 | \
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE15     (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_2 | DMAMUX_RGxCR_SIG_ID_1 | \
...
/**
  ...
  *         @arg @ref LL_DMAMUX_REQ_LPTIM1_IC1
  *         @arg @ref LL_DMAMUX_REQ_LPTIM1_IC2
  *         @arg @ref LL_DMAMUX_REQ_LPTIM1_IC3
  *         @arg @ref LL_DMAMUX_REQ_LPTIM1_IC4
  *         @arg @ref LL_DMAMUX_REQ_LPTIM1_UE
  *         @arg @ref LL_DMAMUX_REQ_LPTIM2_IC1
  *         @arg @ref LL_DMAMUX_REQ_LPTIM2_IC2
  *         @arg @ref LL_DMAMUX_REQ_LPTIM2_UE
  *         @arg @ref LL_DMAMUX_REQ_LPTIM3_IC1
  *         @arg @ref LL_DMAMUX_REQ_LPTIM3_IC2
  *         @arg @ref LL_DMAMUX_REQ_LPTIM3_IC3
  *         @arg @ref LL_DMAMUX_REQ_LPTIM3_IC4
  *         @arg @ref LL_DMAMUX_REQ_LPTIM3_UE
  *         @arg @ref LL_DMAMUX_REQ_LPUART1_RX
  *         @arg @ref LL_DMAMUX_REQ_LPUART1_TX
  *         @arg @ref LL_DMAMUX_REQ_LPUART2_RX
  *         @arg @ref LL_DMAMUX_REQ_LPUART2_TX
  *         @arg @ref LL_DMAMUX_REQ_LPUART3_RX
  *         @arg @ref LL_DMAMUX_REQ_LPUART3_TX
...
/**
  * @brief  Set the number of DMA request that will be autorized after a synchronization event and/or the number of
  *         DMA request needed to generate an event.
  * @note   DMAMUX channel 0 to 6 are mapped to DMA1 channel 1 to 7.
  *         DMAMUX channel 7 to 11 are mapped to DMA2 channel 1 to 5 (** only available on chip which support DMA2 **).
...
/**
  * @brief  Get the number of DMA request that will be autorized after a synchronization event and/or the number of
  *         DMA request needed to generate an event.
  * @note   DMAMUX channel 0 to 6 are mapped to DMA1 channel 1 to 7.
  *         DMAMUX channel 7 to 11 are mapped to DMA2 channel 1 to 5 (** only available on chip which support DMA2 **).
                                                     ...
                                                     uint32_t Polarity)
{
  ...
  MODIFY_REG(((DMAMUX_RequestGen_TypeDef *) \
              ((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 + \
                          (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))->RGCR, DMAMUX_RGxCR_GPOL, Polarity);
}
                                                  ...
                                                  uint32_t RequestSignalID)
{
  ...
  MODIFY_REG(((DMAMUX_RequestGen_TypeDef *) \
              ((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 + \
                          (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))->RGCR, DMAMUX_RGxCR_SIG_ID, RequestSignalID);
}
